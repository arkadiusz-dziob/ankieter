...
public class PytaniaController {
    ...
    public ModelAndView usun(Model model, 
    	...
    	return new ModelAndView("redirect:/pytania?id="+ankieta_id);
    }
    
    @PostMapping({"/pytania/dodaj"})
    public ModelAndView dodaj(Model model, 
    	...
    	return new ModelAndView("redirect:/pytania?id="+id);
    }
    
    @PostMapping({"/pytania/zmien"})
